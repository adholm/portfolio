...
// Projektkort med musföljande Spotlight-effekt
const ProjectCard = ({ project }) => {
    ...
    return (
        ...
        <div className="p-3 flex flex-col flex-1 justify-between bg-white/[0.02] relative z-20">
        <div>
        <h3 className="text-sm sm:text-base font-bold text-white group-hover:text-teal-400 transition-colors mb-1 line-clamp-1">
        {project.name}
        </h3>
        <p className="text-zinc-400 text-xs sm:text-[13px] leading-snug font-normal line-clamp-2">
        {project.desc}
        </p>
        </div>

        {/* Tech Stack */}
        <div className="mt-2.5 pt-2 border-t border-white/10 flex items-center gap-1.5 overflow-hidden whitespace-nowrap">
