const AboutPage = () => {
    return (
        ...
        I am a fresh graduate in Stockholm with a particular passion for Linux, code, automation, UI/UX & cybersecurity. I'm actively looking for my first challenge in tech, so <span className="text-white font-semibold underline decoration-teal-400 decoration-2 underline-offset-2 drop-shadow-[0_0_6px_rgba(45,212,191,0.9)]">if you need a driven and adaptable employee willing to quickly learn your tech stack — contact me!</span>
        <br /><br />
        ...
        <br /><br />
        Besides tech, I enjoy swimming and reading books. :)
        </p>
        </div>
