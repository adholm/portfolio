const AboutPage = () => {
    return (
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 flex-1 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-10 lg:gap-12 my-auto">
        ...
        {/* Sociala medier-knappar (Synkade med Contact.jsx) */}
        <div className="flex flex-wrap gap-3 justify-center drop-shadow-md">
        <a
