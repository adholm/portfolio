            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        {/* Sociala Länkar */}
                        <div className="flex gap-8 drop-shadow-md">
                            
                            {/* Email */}
                            <a href="mailto:holmadam@outlook.com" className="text-gray-300 hover:text-teal-400 transition-colors duration-300" aria-label="Email">
                            ...
                            {/* LinkedIn */}
                            <a href="https://linkedin.com/in/adholm" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-teal-400 transition-colors duration-300" aria-label="LinkedIn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            {/* GitHub */}
                            <a href="https://github.com/adholm" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-teal-400 transition-colors duration-300" aria-label="GitHub">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div className="bg-black/20 backdrop-blur-2xl p-8 sm:p-10 rounded-2xl border border-white/10 shadow-2xl">
                        <form className="space-y-6">
                            ...
                            <button 
                                type="button" 
                                className="w-full bg-teal-500 text-slate-900 font-bold py-4 rounded-lg hover:bg-teal-400 hover:shadow-[0_0_20px_rgba(20,184,166,0.3)] transition-all duration-300 mt-4"
                            >
                                Send Message
                            </button>
