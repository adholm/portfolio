...
const Hero = () => {
    return (
        ...
        {/* 1. Större profilbild för maximalt fokus */}
        ...
        src="/images/pfp.jpeg"
        alt="Adam Holm"
        className="relative w-36 h-36 sm:w-44 sm:h-44 md:w-48 md:h-48 rounded-full object-cover border-2 border-white/20 shadow-2xl transition-transform duration-300 group-hover:scale-105"
        />
        </div>

        {/* 2. Sammanhängande textblock: Större Namn + Beskrivning */}
        <div className="flex flex-col items-center">
        <h1 className="uppercase text-white text-5xl sm:text-6xl md:text-6xl font-extrabold tracking-tighter drop-shadow-lg leading-none">
        Adam Holm
        </h1>

        <p className="mt-2 text-sm sm:text-base font-medium text-gray-300 drop-shadow-md max-w-lg leading-relaxed">
