...
const Contact = () => {
    ...
    return (
        ...
        {/* HÖGER SIDA: Formulär med frostat glastema */}
        <div className="bg-black/40 backdrop-blur-xl p-5 sm:p-6 md:p-7 rounded-xl border border-white/15 shadow-xl shadow-black/50 w-full">
        {status === 'success' && (
            <div className="mb-4 p-3.5 bg-teal-500/20 border border-teal-500/40 rounded-lg text-teal-300 text-xs sm:text-sm font-medium">
            ✓ Message sent successfully! I'll get back to you as soon as possible.
            </div>
        )}

        {status === 'error' && (
            <div className="mb-4 p-3.5 bg-rose-500/20 border border-rose-500/40 rounded-lg text-rose-300 text-xs sm:text-sm font-medium">
            ⚠ {errorMessage}
            </div>
        )}
        ...
        <div>
        <label htmlFor="name" className="block text-[11px] uppercase tracking-wider text-gray-300 mb-1.5 font-semibold">
        Name
        </label>
        <input
        type="text"
        ...
        className="w-full bg-white/[0.04] border border-white/10 rounded-lg px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder-gray-400 focus:outline-none focus:border-teal-500/60 focus:ring-1 focus:ring-teal-500/60 transition-all"
        placeholder="Your Name"
        />
        </div>

        <div>
        <label htmlFor="email" className="block text-[11px] uppercase tracking-wider text-gray-300 mb-1.5 font-semibold">
        Email
        </label>
        <input
        type="email"
        ...
        <div>
        <label htmlFor="message" className="block text-[11px] uppercase tracking-wider text-gray-300 mb-1.5 font-semibold">
        Message
        </label>
        <textarea
        id="message"
        ...
        onChange={handleChange}
        className="w-full bg-white/[0.04] border border-white/10 rounded-lg px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder-gray-400 focus:outline-none focus:border-teal-500/60 focus:ring-1 focus:ring-teal-500/60 transition-all resize-none"
